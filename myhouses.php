...
<div id="blurred">
    ...
    <p style="text-align: center; font-size: 22pt">My houses</p>
    <div style="padding-left: 20px;padding-right: 20px">
        ...
        $total_pages = $mysqli->query("SELECT * FROM houses WHERE username='$username'")->num_rows;
        ...
        if ($stmt = $mysqli->prepare("SELECT * FROM houses WHERE username='$username'ORDER BY building LIMIT ?,?")) {
